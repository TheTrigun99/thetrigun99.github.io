...
C'est pour quoi on s'intérèsse à l'infos brute: la t-value défini comme $\frac{\beta}{SE(\beta)}$ 
La t-value est plus difficile à intnerpréter, car elle nécéssite du contexte pour être interpréter. Elle est néanmoins plus informative que la p-value, celle-ci étant une traduction de la t-value en écrasant de d'information. La p-value est construite à partir de la t-value et du nombre de degré de liberté du modèle qui nous permettent. Le soucis est que en LMM on ne connait pas la loi exacte de la statistique (t-value) sous H0, car on a des observations corrélées, des degrés de liberté flous et des variances aléatoires estimées. 
